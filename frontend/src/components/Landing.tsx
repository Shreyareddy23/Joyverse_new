        ...
        try {
          ...
          if (resp.ok && d.success) {
            ...
            try { 
              ...
              } else if (!skipAuto && d.preferredGame === 'tracing') {
      ...
      <Content>
        ...
        {error ? (
          ...
          <>
            ...
            ) : childData.preferredGame === 'tracing' ? (
              <>
                <GameInfo>Letter tracing selected for you by your therapist.</GameInfo>
                <Instructions>
                  <InstructionTitle>✏️ Letter Tracing</InstructionTitle>
                  <InstructionList>
                    <li>Practice tracing letters to improve handwriting skills.</li>
                    <li>AI will evaluate your tracing to help you improve.</li>
                  </InstructionList>
                </Instructions>
                <PlayButton onClick={() => navigate('/letter-tracing')}>Start Letter Tracing</PlayButton>
              </>
            ) : (
              <>
